...
const {Name,Delivery,Live,Image,GithubLink,Type,Pattern} = data;
    return (
        ...
        <div className={`h-48 bg-blue-400 bg-${Pattern} rounded-sm`}>
        {/* <p className='h-full flex items-center justify-center tracking-wider text-xl text-white'>{Name}</p> */}
        <p className='py-1 px-2 tracking-wide bg-gray-700 rounded w-24 uppercase text-white italic'>
        {Type}</p>
        </div>
        <div className='text-gray-700 flex h-12 items-center justify-end bg-blue-300'>
